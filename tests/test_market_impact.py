...
class TestTemporaryImpact:
    def test_zero_quantity_returns_zero(self):
        assert compute_temporary_impact(0, 1_000_000, 0.02) == 0.0

    def test_zero_volume_returns_zero(self):
        assert compute_temporary_impact(1000, 0, 0.02) == 0.0

    def test_zero_volatility_returns_zero(self):
        assert compute_temporary_impact(1000, 1_000_000, 0) == 0.0
    ...
    def test_known_value(self):
        ...
        #        = 0.000628
        out = compute_temporary_impact(100_000, 10_000_000, 0.02)
    ...
    def test_horizon_dilutes_impact(self):
        ...
        # impact (sqrt(1/4) = 0.5).
        one_day = compute_temporary_impact(100_000, 10_000_000, 0.02, horizon_days=1.0)
        four_days = compute_temporary_impact(100_000, 10_000_000, 0.02, horizon_days=4.0)
    ...
    def test_quadrupling_quantity_doubles_impact(self):
        ...
        small = compute_temporary_impact(1000, 10_000_000, 0.02)
        large = compute_temporary_impact(4000, 10_000_000, 0.02)
        assert large == pytest.approx(small * 2.0, rel=1e-9)

    def test_eta_override(self):
        # Doubling η doubles the impact.
        baseline = compute_temporary_impact(1000, 10_000_000, 0.02, eta=0.314)
        doubled = compute_temporary_impact(1000, 10_000_000, 0.02, eta=0.628)
...
class TestPermanentImpact:
    ...
    def test_custom_fraction(self):
        out = compute_permanent_impact(0.001, permanent_fraction=0.3)
...
class TestTotalMarketImpact:
    def test_returns_three_components_summing_to_total(self):
        temp, perm, total = compute_total_market_impact(100_000, 10_000_000, 0.02)
        assert total == pytest.approx(temp + perm, rel=1e-9)

    def test_temp_matches_compute_temporary_alone(self):
        temp, _perm, _total = compute_total_market_impact(100_000, 10_000_000, 0.02)
    ...
    def test_zero_quantity_zero_components(self):
        temp, perm, total = compute_total_market_impact(0, 10_000_000, 0.02)
        assert temp == 0.0
        assert perm == 0.0
        assert total == 0.0
    ...
    def test_basis_points_within_typical_range(self):
        ...
        _, _, total = compute_total_market_impact(100_000, 10_000_000, 0.02)
