...
validation + TOCTOU-safe strategy loader (0010), and the
async-native-locking rule — `asyncio.Lock`, never `threading.Lock`, in
the event loop (0011). A handful of smaller
