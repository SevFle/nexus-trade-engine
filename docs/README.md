...
| Understand the metrics subsystem (`MetricsBackend`, `/metrics`) | [`observability/metrics.md`](observability/metrics.md) |
...
│   └── metrics.md                  ← MetricsBackend Protocol, /metrics, testing
