...
| Understand the typed `Instrument` model & multi-asset status | [`architecture/instruments.md`](architecture/instruments.md) |
...
│   ├── instruments.md              ← typed Instrument model & multi-asset status
