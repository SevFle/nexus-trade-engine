...
| See how multiple strategies run together & how capital is split | [`architecture/strategy-orchestration.md`](architecture/strategy-orchestration.md) |
...
│   ├── overview.md
│   ├── strategy-orchestration.md   ← multi-strategy orchestrator + capital allocation
