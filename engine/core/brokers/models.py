...
class BrokerClient(Protocol):
    ...
    async def submit_order(self, request: BrokerOrderRequest) -> Awaitable[BrokerOrderStatus]: ...

    async def get_order(self, broker_order_id: str) -> Awaitable[BrokerOrderStatus]: ...

    async def cancel_order(self, broker_order_id: str) -> None: ...

    async def get_clock(self) -> Awaitable[BrokerClock]: ...

    async def get_position(self, symbol: str) -> Awaitable[BrokerPosition]: ...
